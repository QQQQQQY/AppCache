...
import com.example.com.cachetest.BaseApplication;
...
public class SpUtil {
    ...
    private static final String FILE_NAME = "appSpCache";

    private static SharedPreferences sp =
            BaseApplication.getInstance().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        ...
        try {
            switch (type) {
                ...
                case "Long":
                    ...
                    break;
                case "Float":
                    Float a = (Float) defaultValue;
                    result = sp.getFloat(key, a);
                    break;
                case "String":
...
//                    }
     ...
     * @return 保存结果
     */
    public static <K, V> boolean putMapData(String key, Map<K, V> map) {
        boolean result;
     ...
     * @return ArrayMap
     */
    public static <V> ArrayMap<String, V> getMapData(String key, Class<V> clsV) {
        String json = sp.getString(key, "");
